...
class BDFTestCase(unittest.TestCase):
    ...
    def test_bdf1(self):
        ...
        dat = BDF("Newtest17-256.bdf", use_numba=False)
    ...
    def test_bdf2(self):
        ...
        dat = BDF("Newtest17-256.bdf", use_numba=True)
    ...
    def test_bdf4(self):
        ...
        dat1 = BDF("Newtest17-256.bdf", use_numba=False)
        dat2 = BDF("Newtest17-256.bdf", chans=[1, 3, 5], use_numba=False)
        dat3 = BDF("Newtest17-256.bdf", chans=["A3"], use_numba=False)
    ...
    def test_bdf5(self):
        ...
        dat1 = BDF("Newtest17-256.bdf", use_numba=True)
        dat2 = BDF("Newtest17-256.bdf", chans=[1, 3, 5], use_numba=True)
        dat3 = BDF("Newtest17-256.bdf", chans=["A3"], use_numba=True)
    ...
    def test_bdf6(self):
        ...
        dat = BDF("Newtest17-2048.bdf", use_numba=False)
    ...
    def test_bdf7(self):
        ...
        dat = BDF("Newtest17-2048.bdf", use_numba=True)
    ...
    def test_bdf9(self):
        ...
        dat1 = BDF("Newtest17-2048.bdf", use_numba=False)
        dat2 = BDF("Newtest17-2048.bdf", chans=[1, 3, 5], use_numba=False)
        dat3 = BDF("Newtest17-2048.bdf", chans=["A3"], use_numba=False)
    ...
    def test_bdf10(self):
        ...
        dat1 = BDF("Newtest17-2048.bdf", use_numba=True)
        dat2 = BDF("Newtest17-2048.bdf", chans=[1, 3, 5], use_numba=True)
        dat3 = BDF("Newtest17-2048.bdf", chans=["A3"], use_numba=True)
